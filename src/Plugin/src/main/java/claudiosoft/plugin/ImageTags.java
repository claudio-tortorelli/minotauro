 ...
 */
public class ImageTags extends BasePlugin {
    ...
    public void apply(IndexMechanism indexer) throws CTException {
        ...
        try {
            ...
            while (curImage != null) {
                ImageTagsThread thread = new ImageTagsThread(UUID.randomUUID(), curImage, plugConf, new BeanTags(this.getClass().getSimpleName()));

...
Lo scopo è quello di classificare un dataset di immagini molto ampio, corrispondente all'archivio delle foto familiari degli ultimi 25-30 anni.
...
Il software si compone di una serie di tool inserite all'interno di un flusso
